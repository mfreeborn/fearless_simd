...
use erydanos::{
    cos, expf, vatan2q_f32, vcosq_f32, vcosq_f64, vexpq_f32, vexpq_f64, vlnq_f32, vlnq_f64,
    vsinq_f32, vsinq_f64,
};
...
impl Simd for Neon {
    ...
    fn atan2_f32x4(self, y: f32x4<Self>, x: f32x4<Self>) -> f32x4<Self> {
        unsafe { vatan2q_f32(y.into(), x.into()) }.simd_into(self)
    }
    #[inline(always)]
    fn atan2_f32x8(self, y: f32x8<Self>, x: f32x8<Self>) -> f32x8<Self> {
        let (y1, y2) = self.split_f32x8(y);
        let (x1, x2) = self.split_f32x8(x);

        self.combine_f32x4(self.atan2_f32x4(y1, x1), self.atan2_f32x4(y2, x2))
    }
    #[inline(always)]
    fn atan2_f32x16(self, y: f32x16<Self>, x: f32x16<Self>) -> f32x16<Self> {
        let (y1, y2) = self.split_f32x16(y);
        let (x1, x2) = self.split_f32x16(x);

        self.combine_f32x8(self.atan2_f32x8(y1, x1), self.atan2_f32x8(y2, x2))
    }
    #[inline(always)]
    ...
    fn exp_f32x4(self, a: f32x4<Self>) -> f32x4<Self> {
        unsafe { vexpq_f32(a.into()) }.simd_into(self)
    }
    #[inline(always)]
    ...
    fn exp_f64x2(self, a: f64x2<Self>) -> f64x2<Self> {
        unsafe { vexpq_f64(d) }.simd_into(self)
    }
    #[inline(always)]
    ...
    fn sin_cos_f32x4(self, a: f32x4<Self>) -> (f32x4<Self>, f32x4<Self>) {
        let sin = unsafe { vsinq_f32(a.into()) }.simd_into(self);
        let cos = unsafe { vcosq_f32(a.into()) }.simd_into(self);
        (sin, cos)
    }
    #[inline(always)]
    ...
    fn sin_cos_f64x2(self, a: f64x2<Self>) -> (f64x2<Self>, f64x2<Self>) {
        let sin = unsafe { vsinq_f64(a.into()) }.simd_into(self);
        let cos = unsafe { vcosq_f64(a.into()) }.simd_into(self);
        (sin, cos)
    }
    #[inline(always)]
    ...
    fn ln_f32x4(self, a: f32x4<Self>) -> f32x4<Self> {
        unsafe { vlnq_f32(a.into()) }.simd_into(self)
    }
    #[inline(always)]
    ...
    fn ln_f64x2(self, a: f64x2<Self>) -> f64x2<Self> {
        unsafe { vlnq_f64(a.into()) }.simd_into(self)
    }
    #[inline(always)]
    ...
    fn combine_cvtpd_ps(self, a: Self::f64s, b: Self::f64s) -> Self::f32s {
        unsafe { vcvt_high_f32_f64(vcvt_f32_f64(a.into()), b.into()).simd_into(self) }
    }
    #[inline(always)]
    fn level(self) -> Level {
        Level::Neon(self)
