...
use core::ops::*;
#[doc = r#" The SIMD token for the "AVX512" and "FMA" level."#]
...
impl Avx512 {
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = r" The AVX512 and FMA CPU feature must be available."]
    #[inline]
...
impl Simd for Avx512 {
    ...
    fn atan2_f32x16(self, a: f32x16<Self>, b: f32x16<Self>) -> f32x16<Self> {
        let (a1, a2) = self.split_f32x16(a.into());
        let (b1, b2) = self.split_f32x16(b.into());
        self.combine_f32x8(self.atan2_f32x8(a1, b1), self.atan2_f32x8(a2, b2))
    }
    #[inline(always)]
    ...
    #[inline(always)]
    fn combine_cvtpd_ps(self, a: f64x8<Self>, b: f64x8<Self>) -> f32x16<Self> {
        self.combine_f32x8(
            unsafe { _mm512_cvtpd_ps(a.into()) }.simd_into(self),
            unsafe { _mm512_cvtpd_ps(b.into()) }.simd_into(self),
        )
    }
}
impl<S: Simd> SimdFrom<__m512, S> for f32x16<S> {
    #[inline(always)]
    fn simd_from(arch: __m512, simd: S) -> Self {
        Self {
...
impl<S: Simd> SimdFrom<__m512i, S> for i8x64<S> {
    #[inline(always)]
    fn simd_from(arch: __m512i, simd: S) -> Self {
        Self {
            val: unsafe { core::mem::transmute(arch) },
            simd,
        }
...
impl<S: Simd> SimdFrom<__m512d, S> for f64x8<S> {
    #[inline(always)]
    fn simd_from(arch: __m512d, simd: S) -> Self {
        Self {
            val: unsafe { core::mem::transmute(arch) },
            simd,
        }
